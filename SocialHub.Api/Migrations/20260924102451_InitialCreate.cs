        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MediaItems_Workspaces_WorkspaceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlatformAccountId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Posts_MediaItems_MediaId",
                        column: x => x.MediaId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EngagementRate = table.Column<double>(type: "float(5)", precision: 5, scale: 2, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AnalyticsSnapshots_SocialAccounts_SocialAccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Platform = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ExternalPostId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PostPlatforms_SocialAccounts_SocialAccountId",
                        column: x => x.SocialAccountId,
                        principalTable: "SocialAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnalyticsSnapshots_SocialAccountId_Date",
                table: "AnalyticsSnapshots",
                columns: new[] { "SocialAccountId", "Date" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MediaItems_WorkspaceId",
                table: "MediaItems",
                column: "WorkspaceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SocialAccounts_WorkspaceId_Platform_PlatformAccountId",
                table: "SocialAccounts",
                columns: new[] { "WorkspaceId", "Platform", "PlatformAccountId" },
                unique: true);
